      ...
      <div style={{ maxWidth: 640, margin: "0 auto", position: "relative", zIndex: 10 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32 }}>
          <button onClick={() => setShowLevelSelect(false)} style={{
            ...
            onMouseEnter={(event) => { event.target.style.background = "rgba(255,255,255,0.06)"; event.target.style.borderColor = C.borderFocus; }}
            onMouseLeave={(event) => { event.target.style.background = "rgba(255,255,255,0.03)"; event.target.style.borderColor = C.border; }}
          >
