export const STRINGS = {
  en: {
    ...
    configureApiKey: "Optional AI Setup",
    ...
    tagline: "Master Python from scratch.\nNo install. AI optional.",
    subtitle: "30 levels · 3 phases · Open Source",
    welcomeNoInstall: "Runs in your browser",
    welcomeAiOptional: "AI feedback is optional",
    welcomeFirstStep: "Start with Level 1",
    settings: "Settings",
    darkMode: "Dark",
    lightMode: "Light",
    modeSuffix: "Mode",
    ...
    successMatchOutput: "Your output must match exactly:",
    ...
    bonusChallengeText: "Change one value, predict the new output, then run it again.",
    language: "Language",
  ...
  ko: {
    ...
    welcomeNoInstall: "브라우저에서 바로 실행",
    welcomeAiOptional: "AI 피드백은 선택 사항",
    welcomeFirstStep: "1레벨부터 시작",
    settings: "설정",
    darkMode: "다크",
    lightMode: "라이트",
    modeSuffix: "모드",
    ...
    successMatchOutput: "출력이 정확히 일치해야 합니다:",
    ...
    bonusChallenge: "추가 도전",
    bonusChallengeText: "값 하나를 바꾸고 새 출력을 예측한 다음 다시 실행해보세요.",
    language: "언어",
    langDesc: "인터페이스 언어",
    python3: "Python 3",
    xp: "XP",
