export const STRINGS = {
  en: {
    ...
    localBadge: "Local",
    localFeedbackLabel: "Local feedback",
    offlineDesc: "Runs Python in your browser",
    onlineDesc: "Optional AI feedback with your own key",
    loading: "loading...",
    ready: "ready",
    apiKey: "Personal API Key",
    apiKeyDesc: "Get a key at",
    apiKeyPrivacy: "Optional. Stored locally in this browser. Never bundled into the public site.",
    saveKey: "Save Key",
    successCriteria: "Success Criteria",
    successUseConcept: "Use this lesson's concept.",
    successMatchOutput: "Your output should match this expected result:",
    successSampleInput: "The checker uses the sample input below.",
    nextStep: "Next Step",
    coachingFirst: "Check the exact output and make one small change.",
    coachingSecond: "Use the Hint button, then compare your code structure.",
    coachingThird: "Use this pattern as a guide:",
    language: "Language",
    ...
    offlineFallback: "Running with local feedback - add an API key in Settings for expanded feedback",
    localFallbackNotice: "Online evaluation unavailable - using local feedback for this run",
    localFallbackInline: "Online check unavailable - using built-in feedback.",
    apiKeyFallbackInline: "API key issue - using built-in feedback.",
  ...
  ko: {
    ...
    offlineMode: "오프라인 모드",
    localBadge: "로컬",
    localFeedbackLabel: "로컬 피드백",
    offlineDesc: "브라우저에서 Python 실행",
    onlineDesc: "개인 키로 선택적 AI 피드백 사용",
    loading: "로딩 중...",
    ready: "준비 완료",
    apiKey: "개인 API 키",
    apiKeyDesc: "키 발급:",
    apiKeyPrivacy: "선택 사항입니다. 이 브라우저에만 저장되며 공개 사이트 번들에는 포함되지 않습니다.",
    saveKey: "키 저장",
    successCriteria: "성공 기준",
    successUseConcept: "이 레슨의 개념을 사용하세요.",
    successMatchOutput: "출력은 이 예상 결과와 일치해야 합니다:",
    successSampleInput: "채점기는 아래 예시 입력을 사용합니다.",
    nextStep: "다음 단계",
    coachingFirst: "정확한 출력을 확인하고 작은 부분 하나를 바꿔보세요.",
    coachingSecond: "힌트 버튼을 사용한 뒤 코드 구조를 비교해보세요.",
    coachingThird: "이 패턴을 참고하세요:",
    language: "언어",
    langDesc: "인터페이스 언어",
    python3: "Python 3",
    xp: "XP",
    ...
    offlineFallback: "로컬 피드백으로 실행 중 - 설정에서 API 키를 추가하면 더 자세한 피드백을 받을 수 있습니다",
    localFallbackNotice: "온라인 평가를 사용할 수 없어 이번 실행은 로컬 피드백으로 진행합니다",
    localFallbackInline: "온라인 확인 불가 - 기본 피드백 사용 중",
    apiKeyFallbackInline: "API 키 문제 - 기본 피드백 사용 중",
